                ...
                <% if (inscricao == null) { %>
                        ...
                        <form action="ServletCentral" method="post">
                           ...
                           <div class="form-group">
                                <input type="text" class="form-control" id="codigo" placeholder="Código de validação" name="codigo" />
                           </div>
                             <%@include file="error.jsp" %>
                            <p class="text-center"><button type="submit" class="btn btn-default">Validar Documento</button></p>
                        </form>
